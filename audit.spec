...
Source0  : https://people.redhat.com/sgrubb/audit/audit-3.0.3.tar.gz
...
%prep
%setup -q -n audit-3.0.3
cd %{_builddir}/audit-3.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626387361
...
cp %{_builddir}/audit-3.0.3/COPYING %{buildroot}/usr/share/package-licenses/audit/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/audit-3.0.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/audit/3ac522f07da0f346b37b29cd73a60f79e992ffba
%make_install
