...
%prep
%setup -q -n audit-3.0.7
cd %{_builddir}/audit-3.0.7
pushd ..
cp -a audit-3.0.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643051650
...
cp %{_builddir}/audit-3.0.7/COPYING %{buildroot}/usr/share/package-licenses/audit/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/audit-3.0.7/COPYING.LIB %{buildroot}/usr/share/package-licenses/audit/3ac522f07da0f346b37b29cd73a60f79e992ffba
pushd ../buildavx2/
%make_install_v3
popd
%make_install
