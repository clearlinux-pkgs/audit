...
Version  : 3.0.5
Release  : 57
URL      : https://people.redhat.com/sgrubb/audit/audit-3.0.5.tar.gz
Source0  : https://people.redhat.com/sgrubb/audit/audit-3.0.5.tar.gz
...
%prep
%setup -q -n audit-3.0.5
cd %{_builddir}/audit-3.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628728412
...
cp %{_builddir}/audit-3.0.5/COPYING %{buildroot}/usr/share/package-licenses/audit/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/audit-3.0.5/COPYING.LIB %{buildroot}/usr/share/package-licenses/audit/3ac522f07da0f346b37b29cd73a60f79e992ffba
%make_install
